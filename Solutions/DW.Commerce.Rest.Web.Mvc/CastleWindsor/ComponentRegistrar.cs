...
namespace DW.Commerce.Rest.Web.Mvc.CastleWindsor
{
    ...
    public class ComponentRegistrar
    {
        ...
        private static void AddTasksTo(IWindsorContainer container)
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("DW.Commerce.Rest.Tasks")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("DW.Commerce.Rest.Domain"));
        }
        ...
        private static void AddCustomRepositoriesTo(IWindsorContainer container) 
        {
            container.Register(
                AllTypes
                    .FromAssemblyNamed("DW.Commerce.Rest.Infrastructure")
                    .Pick()
                    .WithService.FirstNonGenericCoreInterface("DW.Commerce.Rest.Domain"));
        }
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("DW.Commerce.Rest.Web.Mvc")
                    .Pick()
        ...
        {
            container.Register(
                AllTypes.FromAssemblyNamed("DW.Commerce.Rest.Tasks")
                    .Pick()
                    .WithService.FirstInterface());
        }
    }
